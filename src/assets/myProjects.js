...
export const myProjects = [
    {
        ...
        deployedLink: false,
        screenshot: '',
        description: 'A node.js command line interface that generates an SVG file that fits input requirements. This was created to practice object oriented programming, use of Classes within JS, and Jest Tests.'
    },
    {
        id: 2,
        ...
        deployedLink: false,
        screenshot: '',
        description: 'an API for creating users and their friends, and the users thoughts and reactions to them. Buildin using Express.js and MongoDB'
    },
    {
        id: 3,
        ...
        description: 'A simple timeblock work day scheduler, to help you plan out your day. Written using jquery and dayJS.'
    },
    {
        id: 4,
        ...
        screenshot: '',
        alt: '',
        description: 'A code quiz that runs in the browser and tests JavaScript knowledge. Created to test my JS skills in the quest to become a Coding Bootcamp Graduate. Practicing coding assessments will be useful for the job search after graduation too!'
    },
    {
        id: 5,
        title: 'Visual-Vault',
    ...
    },
    {
        ...
        description: 'Golden Age Cinema themed website for discovering films and saving them to your watchlist.'
    },
]